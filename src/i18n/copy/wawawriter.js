...
const wawawriter = {
  en: {
    ...
    title: 'Wawa Writer',
    lede: 'An AI writing tool for novelists, with tools to continue, expand and rewrite drafts, and break down books.',
    headline: '**Redesigning the homepage** to help writers find their work and AI writing tools more easily.',
    introProblem: 'Promotional content took up too much space on the original homepage, leaving novels and AI tools less visible. Users struggled to quickly find what they needed.',
    introChanges: 'I reduced the promotional banner, gave the works list more prominence, and added clear icons and descriptions for AI tools such as book breakdown, bringing novel writing into focus on the homepage.',
    tags: ['Homepage redesign', 'AI feature navigation', 'Works list improvements'],
    resultsTitle: 'Results after the homepage redesign',
    results: [
      'Sign-up rate increased by **30%**',
      'Homepage bounce rate decreased by **50%**',
      'Time on page increased by **36%**',
      'Book-breakdown usage increased by **230%**',
    ],
  ...
  zh: {
    ...
    title: '蛙蛙写作',
    lede: '面向小说创作者的 AI 写作工具，提供续写、扩写、改写和拆书等功能。',
    headline: '**重构首页**，让创作者更容易找到作品和 AI 写作功能。',
    introProblem: '原首页的营销展示占据较多空间，小说作品和 AI 功能不够突出，用户进入后难以快速找到需要的内容。',
    introChanges: '这次改版中，我缩小了营销 Banner，突出作品列表，并为拆书等 AI 功能补充清晰的图标和说明，让首页更聚焦于小说创作。',
    tags: ['首页改版', '功能入口梳理', '作品列表优化'],
    resultsTitle: '首页改版后的成果',
    results: ['注册率提升 **30%**', '首页跳出率降低 **50%**', '页面停留时长增加 **36%**', '拆书使用率提升 **230%**'],
