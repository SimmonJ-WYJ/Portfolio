...
- Render `src/assets/solvely-plugins/用户首次进入核心功能使用.mp4` in the laptop's internal screen window at `left: 205px`, `top: 78px`, `width: 810px`, and `height: 536px`. The video must not replace the laptop shell.
